...
/**** SE USA "SELECT *" CUANDO SE QUIERE CONSULTAR TODAS LAS COLUMNAS DE UNA TABLA, PARA SER MÁS EFEICIENTE CON LAS CONSULTAS DE PUEDE NOMBRAR LAS COLUMNAS QUE SE NECESITA ***/
